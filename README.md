...
1. **Copy this POC** to a new directory (`cp -r CameraPOC/ NewPOC/`)
...
7. **Rename directory**: from: `android/app/src/main/java/com/camerapoc/` to `android/app/src/main/java/com/newpoc`
8. **Update package references** from `com.camerapoc` to `com.newpoc` (global find and replace)
9. **Update path references** from `com/camerapoc` to `com/newpoc` (global find and replace)
